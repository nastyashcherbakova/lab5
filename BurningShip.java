...
public class BurningShip extends FractalGenerator {
     ...
     * Значения x и y будут равны -2 и -2.5 соответственно, а ширина и высота будут равны 4.
    ...
    public int numIterations(double x, double y)
    {
        ...
        /*
          Функция для фрактала Burning Ship имеет вид: Zn = (abs[Re(zn-1)] + i(abs[img(zn-1)]))^2,
